<section class="dashboard frame active" id="frame-dashboard">
    <div class="dashboard-accordion-title link link--full link--large link--text link--primary" data-click='accordion' data-accordion='accordion-0'>
        ...
        <div class="accordion-arrow right icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M6.301 2.555a.3.3 0 0 0-.424 0l-.99.99a.3.3 0 0 0 0 .424L8.918 8l-4.031 4.029a.303.303 0 0 0 0 .425l.99.989a.3.3 0 0 0 .424 0L11.745 8 6.301 2.555z"/></svg>
        </div>
    </div>
    ...
    <div class="dashboard-accordion-title link link--full link--large link--text link--primary" data-click='accordion' data-accordion='accordion-2'>
        How do I register a ReddId?
    ...
    <section class="accordion" id="accordion-2">
        <div class="dashboard-accordion-content">
            <p>
                Obtain RDD - As ReddID's require a small fee paid to the network, you'll need to obtain RDD.
                This can be done from the Instant Buy button on the "exchange" Tab (coming soon), or from any crypto exchange trading RDD.
    ...
    <div class="dashboard-button button button--center button--large button--full button--primary" data-click="frame" data-frame="wallet-create">Create Wallet</div>
</section>
