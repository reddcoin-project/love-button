<section class="wallet frame" id="frame-wallet-password-confirm">
    ...
    <div class="wallet-field field field--full field--grey" data-focusinout='toggle'>
        <label class="field-text field-text--input">
            <input class="field-mask field-tag" name='password' type="text">
        </label>
    </div>

    <button class="wallet-button wallet-button--primary button button--center button--large button--primary">Confirm Password</button>
