        ...
        if (!response.walletObj.dataAvailable) {
            ...
            Reddcoin.messenger.getUserIds(function (result) {
                ...
                if (result.length > 0) {
                    ...
                    $('.reddid--greyed').replaceWith(`
                        <div class="nav-link nav-link--center" data-click="frame" data-frame="reddid-socials">
                            <div class="button button--red button--faded button--icon button--large tooltip" data-hover="toggle" id="menuRegister">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M7.369 14.729c-1.708 1.72-4.38 1.72-6.088 0-1.707-1.72-1.707-4.486 0-6.131L3.583 6.28c-.075.823 0 1.72.296 2.468L2.69 9.943c-.891.896-.891 2.393 0 3.289a2.321 2.321 0 0 0 3.267 0l2.449-2.467c.893-.896.893-2.394 0-3.291-.371-.374-.371-1.047 0-1.42.373-.374 1.041-.374 1.412 0 1.709 1.72 1.709 4.486 0 6.13l-2.449 2.545zm5.049-5.084c.074-.821 0-1.72-.299-2.468l1.189-1.196c.891-.897.891-2.393 0-3.29a2.323 2.323 0 0 0-3.268 0L7.59 5.158c-.89.897-.89 2.393 0 3.29.373.374.373 1.047 0 1.421-.37.373-1.04.373-1.41 0-1.708-1.72-1.708-4.486 0-6.131l2.449-2.467c1.709-1.719 4.455-1.719 6.092 0a4.31 4.31 0 0 1 0 6.13l-2.303 2.244z"></path></svg>
                                </div>

                                <span class="tooltip-content tooltip-content--n tooltip-content--message">Link Social media Accounts</span>
                            </div>
                        </div>
                    `);
