<section class="index-frame">
    ...
    <span class="index-frame-tag">Wallet Seed Confirm Frame</span>
        ...
        <div class="wallet index-frame-content-wrapper">
            ...
            <div class="wallet-field field field--border field--primary" data-focusinout='toggle'>
                <label class="field-text field-text--textarea">
                    <textarea class="field-mask field-tag field-tag--autoresize" name="seed"></textarea>
                </label>
            </div>

            <button class="wallet-button wallet-button--primary button button--center button--large button--primary">
                Confirm Wallet Seed
            </button>
